...
export class SeedService {
  ...
  async seedAdminUser(): Promise<User> {
    try {
      ...
      if (existingAdmin) {
        this.logger.log(
          'Admin user "ORIG" already exists. Updating password...',
        );
        ...
        this.logger.log('✅ Admin user "ORIG" updated successfully');
        return existingAdmin;
      }

      this.logger.log('Creating admin user "ORIG"...');
      ...
      this.logger.log('✅ Admin user "ORIG" created successfully');
      this.logger.log('   Username: ORIG');
